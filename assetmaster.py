...
class Main:
    ...
    def read_model(self, glob_gpkg):
        ...
        for single_model_file in files:
            single_model_provider = modelprovider.ModelProvider.from_file(
                single_model_file
            )
    ...
    def run(self):
        ...
        if self._check_querymode():
            self.query_result = self.queryModelfromRoi(
    ...
    def create_with_arg_parser(cls):
        ...
        arg_parser.add_argument(
            "assettype", help="Type of exposed assets", type=str, default="res"
        )
        arg_parser.add_argument(
            "querymode",
